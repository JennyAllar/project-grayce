...
ActiveRecord::Schema.define(version: 2020_07_28_164650) do
  ...
  create_table "care_plans", force: :cascade do |t|
    ...
    t.string "status"
    t.bigint "expert_id"
    t.index ["expert_id"], name: "index_care_plans_on_expert_id"
  end
  ...
  create_table "matches", id: :integer, default: nil, force: :cascade do |t|
